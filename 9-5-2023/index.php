            ...
            <div class="col-md-6 offset-md-3">
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg mt-3"><i class="fa fa-plus"
                                aria-hidden="true"></i> Add Todo</button>
                    </div>
    ...
    <?php if ($_SESSION['logged_in']): ?>
                    ...
                    ?>">
                        ...
                        <div class="d-flex">
                            ...
                            <button class="btn btn-primary edit"><i class="fa fa-pencil-square" aria-hidden="true"></i>
                                Edit</button>
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                <button type="submit" class="btn btn-danger mr-2 ml-2" name="delete"
                                    value="<?php echo $todo['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i>
                                    Delete</button>
                            </form>
        ...
        <?php else: ?>
            <div class="alert alert-warning" role="alert">
                You must <a href="login.php">login</a> before seeing todos!
            </div>
        </div>
    <?php endif; ?>
</div>
