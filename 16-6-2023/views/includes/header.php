            ...
            <div class="collapse navbar-collapse" id="nvbCollapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php if ($_SESSION['logged_in']): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ROOT; ?>user"><i class="fas fa-user"></i>
                                <?php echo $_SESSION['user_name']; ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ROOT; ?>logout"><i class="fa fa-sign-in-alt fa-fw mr-1 fa-rotate-180"></i>Logout</a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item pl-1">
