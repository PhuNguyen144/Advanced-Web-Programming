  ...
  <div class="col-md-6">
    <div class="card flex-md-row mb-4 box-shadow h-md-250">
      <div class="card-body d-flex flex-column align-items-start">
        ...
        <h3 class="mb-0">
          <a class="text-dark" href="#"><?php echo $post['post_title'];?></a>
        </h3>
        <div class="mb-1 text-muted"><?php echo $post['display_name'];?></div>
        <p class="card-text mb-auto"><?php echo $post['post_excerpt'];?></p>
        <p class="card-text mb-auto">Release date: <?php echo $post['post_date'];?></p>
        <a href="post.php?id=<?php echo $post['ID'];?>">Continue reading</a>
      </div>
